                ...
                <div class="page_title">संस्कृतग्रन्थाः</div>
					<div style="text-align: end; margin-bottom: 30px;">
						<form>
						      ...
						      <input type="hidden" id="language" name="language" value="sanskrit">
						</form>
					</div>
...
$query = "select * from sanskrit_books_list order by slno";
...
if($num_rows > 0)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($authid != 0)
		{
			...
			foreach ($aut as $aid)
			{
				$query2 = "select * from author_sanskrit where authid=$aid";
