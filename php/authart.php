...
<div class="page">
	...
	<div class="content">
		...
		<div class="colmiddle">
			...
			echo("<div class=\"title\">$authorname</div>");
			
				include("connect.php");
				$db = mysql_connect("localhost",$user,$password) or die("Not connected to database");
				$rs = mysql_select_db($database,$db) or die("No Database");

				$query = "select * from article where authorname='$authorname' order by title, volume, issue, page";
				...
				if($num_rows)
				{
					...
					//	if($issue>10){$issue1 = $issue;}
						echo("<li>");
						echo("<span class=\"titlespan\"><a href=\"../Volumes/apm$volume/apm$jn/apm$jn.djvu?djvuopts&page=$page&zoom=page\" target=\"_blank\">$title</a></span>&nbsp;|&nbsp;<span class=\"titlespan\"><a href=\"monthly.php?volume=$volume&issue=$issue&year=$year&month=$month\">$year,$month</a></span><br /><br />");
						echo("</li>\n");
					}
					echo("</ul>");
				}
